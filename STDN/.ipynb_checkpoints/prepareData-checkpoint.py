...
# python STDN/prepareData.py --config STDN/conf/METRLA_1dim_24.conf
...
if __name__ == "__main__":
    ...
    train_ratio = data_config.getfloat('train_ratio', fallback=0.6)
    val_ratio = data_config.getfloat('val_ratio', fallback=0.2)
    test_ratio = data_config.getfloat('test_ratio', fallback=0.2)
